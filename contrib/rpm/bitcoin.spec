...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 8823
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 8824
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 18823
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 18824
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 8823
	%{_sbindir}/semanage port -d -p tcp 8824
	%{_sbindir}/semanage port -d -p tcp 18823
	%{_sbindir}/semanage port -d -p tcp 18824
