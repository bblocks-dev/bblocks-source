...
* bblocks.conf: contains configuration settings for bblocksd or bblocks-qt
* bblocksd.pid: stores the process id of bblocksd while running
...
* debug.log: contains debug information and general logging generated by bblocksd or bblocks-qt
