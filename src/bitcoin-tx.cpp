...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bblocks-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bblocks-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bblocks transaction") + "\n" +
              "  bblocks-tx [options] -create [commands]   " + _("Create hex-encoded bblocks transaction") + "\n" +
              "\n";
