...
const char * const BITCOIN_CONF_FILENAME = "bblocks.conf";
const char * const BITCOIN_PID_FILENAME = "bblocksd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "bblocks";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/bblocks";
#else
    // Unix
    return pathRet / ".bblocks";
#endif
#endif
}
