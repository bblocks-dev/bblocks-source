...
"""Verify that starting bblocks with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bblocks with -h for help text")
        ...
        self.log.info("Start bblocks with -version for version information")
